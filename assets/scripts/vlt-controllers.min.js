    ...
    VLTJS.counterUp = {
        init: function() {
            if (void 0 !== e.fn.numerator) {
                e(".vlt-counter-up, .vlt-counter-up-small").each(function() {
                    var t = e(this),
        ...
        init: function() {
            if (e(".vlt-is--custom-cursor").length) {
                ...
                var t = e(".vlt-custom-cursor"),
                    ...
                    o = .25;
                "undefined" != typeof gsap && (gsap.set(n, {
                    xPercent: -50,
                    yPercent: -50
                    ...
                    a.x += (i.x - a.x) * o, a.y += (i.y - a.y) * o, gsap.set(n, {
                        x: a.x,
                        y: a.y
                    })
...
function(e) {
    ...
    VLTJS.fullpageSlider = {
        init: function() {
            function t() {
                s.find(".pp-section.active").scrollTop() > 0 ? e(".vlt-navbar").addClass("vlt-navbar--solid") : e(".vlt-navbar").removeClass("vlt-navbar--solid")
            }
            ...
            function i() {
                switch (s.find(".vlt-section.active").data("brightness")) {
                    case "light":
            ...
            function a(e, t) {
                switch (e) {
                    case "down":
                        r.find("li:nth-child(" + t + ")").prevAll().addClass("prev");
                        break;
                    case "up":
            ...
            function o() {
                var e = s.find(".vlt-section.active"),
                    t = e.index();
                0 == t ? l.html('<a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="square" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><polyline points="19 12 12 19 5 12"></polyline></svg></a>') : l.html(VLTJS.addLedingZero(t + 1))
            }
				var page_name = document.location.pathname;
               
				if(page_name != '/about' || page_name != '/contact' || page_name != '/rollover' || page_name != '/pricing' || page_name != '/education' || page_name != '/execution' || page_name != '/platforms' || page_name != '/blogs'}){
                
					     if (void 0 !== e.fn.pagepiling) {
                var s = e(".vlt-fullpage-slider"),
                    r = s.find(".vlt-fullpage-slider-progress-bar"),
                    l = s.find(".vlt-fullpage-slider-numbers"),
                    c = !!s.data("loop-top"),
                    u = !!s.data("loop-bottom"),
                    d = s.data("speed") || 800,
                    f = [];
				
				VLTJS.body.css  ("overflow","hidden")  , VLTJS.html.css("overflow", "hidden"), s.find("[data-anchor]").each(function() {
                    ...
                    afterRender: function() {
                        n(), i(), o(), VLTJS.window.trigger("vlt.change-slide")
                    },
                    onLeave: function(e, t, n) {
                        i(), a(n, t), o(), VLTJS.window.trigger("vlt.change-slide")
                    },
                    ...
                    e(this).scrollTop() > 0 ? e(".vlt-navbar").addClass("vlt-navbar--solid") : e(".vlt-navbar").removeClass("vlt-navbar--solid")
                })
            }
				 }else{
				   if (void 0 !== e.fn.pagepiling) {
...
function(e) {
    ...
    VLTJS.menuOffcanvas = {
        ...
        init: function() {
            var n = e(".vlt-offcanvas-menu"),
                i = n.find("ul.sf-menu"),
                a = i.find("> li"),
                o = e(".vlt-offcanvas-menu__header"),
                s = e(".vlt-offcanvas-menu__footer > div"),
                r = e(".js-offcanvas-menu-open"),
                l = e(".js-offcanvas-menu-close"),
                c = e(".vlt-site-overlay");
            void 0 !== e.fn.superclick && i.superclick({
                delay: 300,
                cssArrows: !1,
                animation: {
                    opacity: "show",
                ...
                e.preventDefault(), t || VLTJS.menuOffcanvas.open_menu(n, c, a, o, s)
            }), l.on("click", function(e) {
                e.preventDefault(), t && VLTJS.menuOffcanvas.close_menu(n, c, a, o, s)
            }), c.on("click", function(e) {
                e.preventDefault(), t && VLTJS.menuOffcanvas.close_menu(n, c, a, o, s)
            }), VLTJS.document.keyup(function(e) {
                27 === e.keyCode && t && (e.preventDefault(), VLTJS.menuOffcanvas.close_menu(n, c, a, o, s))
            }), a.filter("[data-menuanchor]").on("click", "a", function() {
                t && VLTJS.menuOffcanvas.close_menu(n, c, a, o, s)
            })
        },
        ...
        init: function() {
            if ("undefined" != typeof gsap) {
                e(".vlt-progress-bar").each(function() {
                    ...
                    VLTJS.window.on("vlt.change-slide", function() {
                        t.parents(".vlt-section").hasClass("active") && (o.count = 0, t.find(".vlt-progress-bar__title > .counter").text(Math.round(o.count)), gsap.set(t.find(".vlt-progress-bar__bar > span"), {
                            width: 0
                        }), gsap.to(o, i / 1e3 / 2, {
                            count: n,
                            delay: a / 1e3,
                            onUpdate: function() {
                                t.find(".vlt-progress-bar__title > .counter").text(Math.round(o.count))
                            }
    ...
    VLTJS.projectShowcase = {
        initSlider: function() {
            if ("undefined" != typeof Swiper) {
                var t = e(".vlt-project-showcase-slider .swiper-container");
                new Swiper(t, {
                    speed: 1e3,
                    spaceBetween: 30,
                    grabCursor: !0,
        ...
        initParallax: function() {
            if ("undefined" != typeof gsap) {
                var t, n, i = e(".vlt-project-showcase"),
                    a = i.find(".vlt-project-showcase__items"),
                    o = a.find(".vlt-project-showcase__item"),
                    s = i.find(".vlt-project-showcase__images"),
                    r = s.find(".vlt-project-showcase__image"),
                    l = i.outerWidth(!0),
                    c = s.outerWidth(!0),
                    u = a.outerWidth(),
                    d = (l - c) / l;
                t = u / l - 1, t = (l - u) / l, o.on("mouseenter", function() {
                    o.removeClass("is-active"), r.removeClass("is-active"), e(this).addClass("is-active"), r.eq(e(this).index()).addClass("is-active")
                }), o.eq(0).trigger("mouseenter"), VLTJS.window.on("mousemove", function(e) {
...
function(e) {
    ...
    VLTJS.testimonialSlider = {
        init: function() {
            if ("undefined" != typeof Swiper) {
                e(".vlt-testimonial-slider .swiper-container").each(function() {
                    e(this).find(".swiper-wrapper > *").wrap('<div class="swiper-slide">'), new Swiper(this, {
                        speed: 1e3,
                        spaceBetween: 30,
                        grabCursor: !0,
                        effect: "coverflow",
                        slidesPerView: 1,
                        navigation: {
                            nextEl: e(".vlt-testimonial-slider-controls .next"),
                            prevEl: e(".vlt-testimonial-slider-controls .prev")
                        },
                        pagination: {
                            el: e(".vlt-testimonial-slider-controls .pagination"),
                            clickable: !1,
                            type: "fraction",
                            renderFraction: function(e, t) {
                                return '<span class="' + e + '"></span><span class="sep">/</span><span class="' + t + '"></span>'
                            }
                        }
                    })
                })
...
function(e) {
    ...
    VLTJS.timelineSlider = {
        init: function() {
            if ("undefined" != typeof Swiper) {
                e(".vlt-timeline-slider .swiper-container").each(function() {
                    e(this).find(".swiper-wrapper > *").wrap('<div class="swiper-slide">'), new Swiper(this, {
                        speed: 1e3,
                        spaceBetween: 0,
                        grabCursor: !0,
                        slidesPerView: 1,
                        navigation: {
                            nextEl: e(".vlt-timeline-slider-controls .next"),
                            prevEl: e(".vlt-timeline-slider-controls .prev")
                        },
                        pagination: {
                            el: e(".vlt-timeline-slider-controls .pagination"),
                            clickable: !1,
                            type: "fraction",
                            renderFraction: function(e, t) {
                                return '<span class="' + e + '"></span><span class="sep">/</span><span class="' + t + '"></span>'
